...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "reprogrammation moteur Lyon",
    "reprogrammation moteur Grenoble",
    "reprogrammation moteur Saint-Étienne",
    "reprogrammation moteur Clermont-Ferrand",
    "reprogrammation moteur Annecy",
    "reprogrammation moteur Chambéry",
    "reprogrammation moteur Valence",
    "reprogrammation moteur Auvergne-Rhône-Alpes",
    "conversion E85 Lyon",
    "conversion E85 Auvergne-Rhône-Alpes",
    "diagnostic électronique Lyon",
    "clonage calculateur Lyon",
    "clé automobile Lyon",
    "reprogrammation DSG Lyon",
    "réparation ECU Auvergne-Rhône-Alpes",
    "technicien ECU itinérant Auvergne-Rhône-Alpes",
  ],
