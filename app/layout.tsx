...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "reprogrammation moteur Paris",
    "reprogrammation moteur Marseille",
    "reprogrammation moteur Toulouse",
    "reprogrammation moteur Bordeaux",
    "reprogrammation moteur Lille",
    "reprogrammation moteur Nantes",
    "reprogrammation moteur Strasbourg",
    "reprogrammation moteur Nice",
    "reprogrammation moteur Grenoble",
    "reprogrammation moteur Montpellier",
    "reprogrammation moteur Rennes",
    "reprogrammation moteur déplacement domicile",
    "technicien ECU itinérant France",
  ],
